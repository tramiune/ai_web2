...
def _load_videoaieasy_accounts() -> list[dict[str, Any]]:
            ...
            try:
                for item in _json.loads(raw):
                    ...
                    if email and password:
                        accounts.append({"id": _account_id(email), "email": email, "password": password})
            except Exception:
                pass
        else:
...
def _load_xiaoyang_accounts() -> list[dict[str, Any]]:
    accounts: list[dict[str, Any]] = []
